        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $sql1 = "DROP PROCEDURE IF EXISTS getBauturiByTip";
                    $sql2 = "CREATE PROCEDURE getBauturiByTip(
                        IN TipBautura VARCHAR(50)
                    )
                    BEGIN
                        SELECT *
                        FROM bauturi
                        WHERE tip_bautura = TipBautura;
                    END";
                    ...
                    $sql = "CALL getBauturiByTip(:tip_bautura)";
                    $stmt = $con->prepare($sql);
                    $stmt->bindParam(':tip_bautura', $tip_bautura);
                    $stmt->execute();
